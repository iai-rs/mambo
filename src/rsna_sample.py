...
class RSNA_Dataset(Dataset):
    def __init__(self, csv_path='/home/a800_9010/lun2/data/RSNA/train.csv', images_path='/home/a800_9010/lun2/data/RSNA/train_images', only_birads_labeled=False, transform=None, target_transform=None):
...
dst_path = '/home/jovisic/projects/mambo/src/data/rsna'

os.makedirs(dst_path, exist_ok=True)

for i in itertools.count():
    for j, patch in enumerate(RSNA_Dataset()):
