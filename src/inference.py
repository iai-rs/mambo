...
from config import IS_COND, OVERLAP, MID_IMAGE_SIZE, FINAL_IMAGE_SIZE, timesteps
...
if __name__ == "__main__":
    ...
    index=0
    num_images = 200
    base_dir = f'/lustre/seed/vindr_birads_cond/{str(img_class)}'
    while index < num_images:
        ...
        save_image_to_dir(final_img, str(Path(save_dir) / f'whole_middle.png'))
