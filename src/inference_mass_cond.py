...
if __name__ == "__main__":
    ...
    whole_img_model_path = '../notebooks//artifacts/vindr_cvpr_mass_real:v322/model_83999.pt'
    ...
    local_context_model_path = '../notebooks/artifacts/vindr_cond_lcl_ctx:v131/model_110000.pt'
    ...
    patch_model_path = '/lustre/mambo/models/artifacts/vindr_3c_256_v2:v84/model_169999.pt'
    patch_model = load_model(patch_model_path, channels=3)

    # MAMBO pipeline - generate new images in full resolution
    index=0
    num_images = 1000
    base_dir = f'/lustre/seed/vindr_mass/0/'
    while index < num_images:
        ...
        local_contexts = generate_patches(local_context_model, inputs, black_idx, total_timesteps=total_timesteps, sampling_timesteps=150, eta=1.0, overlap=OVERLAP, device=device, cond_idx=1)
        ...
        patches = generate_patches(patch_model, inputs, black_idx, total_timesteps=total_timesteps, sampling_timesteps=150, eta=1.0, overlap=OVERLAP, device=device, cond_idx=None)
